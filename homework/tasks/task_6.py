...
class FastHandlerWithLongBackgroundTask:
    ...
    async def handle_request(self) -> None:
        """
        Check that a coroutine in the event loop.
        """
    ...
    async def close(self) -> None:
        """
        Cancels all coroutines that are unfinished.
        """
        # Этот метод будет вызван при завершении работы, все
        # незавершённые корутины, полученные из create_long_task,
